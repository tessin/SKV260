...
<svrl:ns-prefix-in-attribute-values uri="http://xmls.skatteverket.se/se/skatteverket/ai/gemensamt/infoForBeskattning/8.0" prefix="gm"/>
<svrl:ns-prefix-in-attribute-values uri="http://xmls.skatteverket.se/se/skatteverket/ai/komponent/infoForBeskattning/8.0" prefix="ku"/>
<svrl:ns-prefix-in-attribute-values uri="http://xmls.skatteverket.se/se/skatteverket/ai/instans/infoForBeskattning/8.0" prefix="kuin"/>
...
<!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="ku:Blankett" priority="1033" mode="M5">
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU10" priority="1032" mode="M5">
...
<svrl:text>045#Du har angett Utländskt skatteregistreringsnummer (TIN), fält 252. Då ska du också ange vilket land det gäller i TIN-land, fält 076</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="not(ku:SocialAvgiftsAvtal) or boolean(//ku:UppgiftslamnareKU10/ku:UppgiftslamnarId[starts-with(text(),'16302') or starts-with(text(),'16502') or starts-with(text(),'16902') or starts-with(text(),'16934')]) "/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(ku:SocialAvgiftsAvtal) or boolean(//ku:UppgiftslamnareKU10/ku:UppgiftslamnarId[starts-with(text(),'16302') or starts-with(text(),'16502') or starts-with(text(),'16902') or starts-with(text(),'16934')])">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>190#Organisationsnumret du har angett uppfyller inte formatkravet för en utländsk arbetsgivare. Du kan därför inte fylla i Socialavgiftsavtal finns (fält 093), dvs. att du är en utländsk arbetsgivare som tecknat avtal om att den anställde ska redovisa och betala arbetsgivaravgifter i arbetsgivarens ställe</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU13" priority="1031" mode="M5">
...
<svrl:text>048#Felet förekommer ej på fil</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="not(ku:SocialAvgiftsAvtal) or boolean(//ku:UppgiftslamnareKU13/ku:UppgiftslamnarId[starts-with(text(),'16302') or starts-with(text(),'16502') or starts-with(text(),'16902') or starts-with(text(),'16934')]) "/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(ku:SocialAvgiftsAvtal) or boolean(//ku:UppgiftslamnareKU13/ku:UppgiftslamnarId[starts-with(text(),'16302') or starts-with(text(),'16502') or starts-with(text(),'16902') or starts-with(text(),'16934')])">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>190#Organisationsnumret du har angett uppfyller inte formatkravet för en utländsk arbetsgivare. Du kan därför inte fylla i Socialavgiftsavtal finns (fält 093), dvs. att du är en utländsk arbetsgivare som tecknat avtal om att den anställde ska redovisa och betala arbetsgivaravgifter i arbetsgivarens ställe</svrl:text>
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU14" priority="1030" mode="M5">
...
<svrl:text>050#Kategori, Ett av alternativen A - F, fält 092, ska alltid anges</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="not(ku:SocialAvgiftsAvtal) or boolean(//ku:UppgiftslamnareKU14/ku:UppgiftslamnarId[starts-with(text(),'16302') or starts-with(text(),'16502') or starts-with(text(),'16902') or starts-with(text(),'16934')]) "/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(ku:SocialAvgiftsAvtal) or boolean(//ku:UppgiftslamnareKU14/ku:UppgiftslamnarId[starts-with(text(),'16302') or starts-with(text(),'16502') or starts-with(text(),'16902') or starts-with(text(),'16934')])">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>190#Organisationsnumret du har angett uppfyller inte formatkravet för en utländsk arbetsgivare. Du kan därför inte fylla i Socialavgiftsavtal finns (fält 093), dvs. att du är en utländsk arbetsgivare som tecknat avtal om att den anställde ska redovisa och betala arbetsgivaravgifter i arbetsgivarens ställe</svrl:text>
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU16" priority="1029" mode="M5">
...
<svrl:text>045#Du har angett Utländskt skatteregistreringsnummer (TIN), fält 252. Då ska du också ange vilket land det gäller i TIN-land, fält 076</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="not(ku:SocialAvgiftsAvtal) or boolean(//ku:UppgiftslamnareKU16/ku:UppgiftslamnarId[starts-with(text(),'16302') or starts-with(text(),'16502') or starts-with(text(),'16902') or starts-with(text(),'16934')]) "/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(ku:SocialAvgiftsAvtal) or boolean(//ku:UppgiftslamnareKU16/ku:UppgiftslamnarId[starts-with(text(),'16302') or starts-with(text(),'16502') or starts-with(text(),'16902') or starts-with(text(),'16934')])">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>190#Organisationsnumret du har angett uppfyller inte formatkravet för en utländsk arbetsgivare. Du kan därför inte fylla i Socialavgiftsavtal finns (fält 093), dvs. att du är en utländsk arbetsgivare som tecknat avtal om att den anställde ska redovisa och betala arbetsgivaravgifter i arbetsgivarens ställe</svrl:text>
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU17" priority="1028" mode="M5">
...
<svrl:text>048#Felet förekommer ej på fil</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="not(ku:SocialAvgiftsAvtal) or boolean(//ku:UppgiftslamnareKU17/ku:UppgiftslamnarId[starts-with(text(),'16302') or starts-with(text(),'16502') or starts-with(text(),'16902') or starts-with(text(),'16934')]) "/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(ku:SocialAvgiftsAvtal) or boolean(//ku:UppgiftslamnareKU17/ku:UppgiftslamnarId[starts-with(text(),'16302') or starts-with(text(),'16502') or starts-with(text(),'16902') or starts-with(text(),'16934')])">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>190#Organisationsnumret du har angett uppfyller inte formatkravet för en utländsk arbetsgivare. Du kan därför inte fylla i Socialavgiftsavtal finns (fält 093), dvs. att du är en utländsk arbetsgivare som tecknat avtal om att den anställde ska redovisa och betala arbetsgivaravgifter i arbetsgivarens ställe</svrl:text>
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU18" priority="1027" mode="M5">
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU19" priority="1026" mode="M5">
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU20" priority="1025" mode="M5">
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU21" priority="1024" mode="M5">
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU25" priority="1023" mode="M5">
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU26" priority="1022" mode="M5">
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU28" priority="1021" mode="M5">
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU30" priority="1020" mode="M5">
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU31" priority="1019" mode="M5">
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU32" priority="1018" mode="M5">
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU34" priority="1017" mode="M5">
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU35" priority="1016" mode="M5">
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU40" priority="1015" mode="M5">
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU41" priority="1014" mode="M5">
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU50" priority="1013" mode="M5">
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU52" priority="1012" mode="M5">
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU53" priority="1011" mode="M5">
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU55" priority="1010" mode="M5">
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU65" priority="1009" mode="M5">
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU68" priority="1007" mode="M5">
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ku:KU68"/>

		<!--ASSERT -->
<xsl:choose>
<xsl:when test="not(ku:UppgiftslamnareKU68/ku:UppgiftslamnarId) or not(ku:InkomsttagareKU68/ku:Inkomsttagare) or ku:UppgiftslamnareKU68/ku:UppgiftslamnarId != ku:InkomsttagareKU68/ku:Inkomsttagare"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(ku:UppgiftslamnareKU68/ku:UppgiftslamnarId) or not(ku:InkomsttagareKU68/ku:Inkomsttagare) or ku:UppgiftslamnareKU68/ku:UppgiftslamnarId != ku:InkomsttagareKU68/ku:Inkomsttagare">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>053#Du har angett samma person-/organisationsnummer för den kontrolluppgiften avser i Person-/organisationsnummer, fält 215, som du angett som uppgiftslämnare. Det kan aldrig vara samma person</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="not(ku:Borttag) or (ku:Borttag and (count(ku:Borttag) + count(ku:UppgiftslamnareKU68/ku:UppgiftslamnarId) + count(ku:Inkomstar) + count(ku:Specifikationsnummer) + count(ku:InkomsttagareKU68/ku:Inkomsttagare) + count(ku:InkomsttagareKU68/ku:Fodelsetid) + count(ku:InkomsttagareKU68/ku:AnnatIDNr) = count(*) - 2 + count(//ku:UppgiftslamnareKU68/*) + count(//ku:InkomsttagareKU68/*)))"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(ku:Borttag) or (ku:Borttag and (count(ku:Borttag) + count(ku:UppgiftslamnareKU68/ku:UppgiftslamnarId) + count(ku:Inkomstar) + count(ku:Specifikationsnummer) + count(ku:InkomsttagareKU68/ku:Inkomsttagare) + count(ku:InkomsttagareKU68/ku:Fodelsetid) + count(ku:InkomsttagareKU68/ku:AnnatIDNr) = count(*) - 2 + count(//ku:UppgiftslamnareKU68/*) + count(//ku:InkomsttagareKU68/*)))">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>055#När Borttag, fält 205, är ifyllt får inte några andra fält förutom identifikatorerna (UppgiftslamnarId, fält 201, Inkomstar, fält 203, Specifikationsnummer, fält 570, Inkomsttagare, fält 215, Fodelsetid, fält 222 och AnnatIdNr, fält 224) vara ifyllda</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU68/ku:Fodelsetid or ku:InkomsttagareKU68/ku:AnnatIDNr or ku:InkomsttagareKU68/ku:Inkomsttagare"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU68/ku:Fodelsetid or ku:InkomsttagareKU68/ku:AnnatIDNr or ku:InkomsttagareKU68/ku:Inkomsttagare">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>056#Du har inte angett Person-/organisationsnummer, fält 215, och inte heller Födelsetid, fält 222, eller Annat ID-nummer (för juridiska personer), fält 224. Någon av dessa ska anges</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU68/ku:Fornamn or not(ku:InkomsttagareKU68/ku:Fodelsetid) or ku:Borttag"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU68/ku:Fornamn or not(ku:InkomsttagareKU68/ku:Fodelsetid) or ku:Borttag">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>057#Du har angett Födelsetid, fält 222. Du ska då också ange Förnamn, fält 216</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU68/ku:Fornamn or ku:Borttag or not(ku:InkomsttagareKU68/ku:Inkomsttagare) or (string-length(ku:InkomsttagareKU68/ku:Inkomsttagare) != 12) or number(substring(ku:InkomsttagareKU68/ku:Inkomsttagare,1,4)) &lt;= 1800 or number(substring(ku:InkomsttagareKU68/ku:Inkomsttagare,7,2)) &lt;= 60"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU68/ku:Fornamn or ku:Borttag or not(ku:InkomsttagareKU68/ku:Inkomsttagare) or (string-length(ku:InkomsttagareKU68/ku:Inkomsttagare) != 12) or number(substring(ku:InkomsttagareKU68/ku:Inkomsttagare,1,4)) &lt;= 1800 or number(substring(ku:InkomsttagareKU68/ku:Inkomsttagare,7,2)) &lt;= 60">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>142#Du har angett ett s.k. samordningsnummer i fältet Person-/organisationsnummer, fält 215. Du ska då också ange Förnamn, fält 216</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU68/ku:Efternamn or not(ku:InkomsttagareKU68/ku:Fodelsetid) or ku:Borttag"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU68/ku:Efternamn or not(ku:InkomsttagareKU68/ku:Fodelsetid) or ku:Borttag">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>058#Du har angett Födelsetid, fält 222. Du ska då också ange Efternamn, fält 217</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU68/ku:Efternamn or ku:Borttag or not(ku:InkomsttagareKU68/ku:Inkomsttagare) or (string-length(ku:InkomsttagareKU68/ku:Inkomsttagare) != 12) or number(substring(ku:InkomsttagareKU68/ku:Inkomsttagare,1,4)) &lt;= 1800 or number(substring(ku:InkomsttagareKU68/ku:Inkomsttagare,7,2)) &lt;= 60"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU68/ku:Efternamn or ku:Borttag or not(ku:InkomsttagareKU68/ku:Inkomsttagare) or (string-length(ku:InkomsttagareKU68/ku:Inkomsttagare) != 12) or number(substring(ku:InkomsttagareKU68/ku:Inkomsttagare,1,4)) &lt;= 1800 or number(substring(ku:InkomsttagareKU68/ku:Inkomsttagare,7,2)) &lt;= 60">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>143#Du har angett ett s.k. samordningsnummer i fältet Person-/organisationsnummer, fält 215. Du ska då också ange Efternamn, fält 217</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU68/ku:Gatuadress or not(ku:InkomsttagareKU68/ku:Fodelsetid) or ku:Borttag or ku:InkomsttagareKU68/ku:FriAdress"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU68/ku:Gatuadress or not(ku:InkomsttagareKU68/ku:Fodelsetid) or ku:Borttag or ku:InkomsttagareKU68/ku:FriAdress">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>059#Du har angett Födelsetid, fält 222. Du ska då också ange Gatuadress, fält 218</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU68/ku:Gatuadress or ku:Borttag or not(ku:InkomsttagareKU68/ku:Inkomsttagare) or (string-length(ku:InkomsttagareKU68/ku:Inkomsttagare) != 12) or number(substring(ku:InkomsttagareKU68/ku:Inkomsttagare,1,4)) &lt;= 1800 or number(substring(ku:InkomsttagareKU68/ku:Inkomsttagare,7,2)) &lt;= 60 or ku:InkomsttagareKU68/ku:FriAdress"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU68/ku:Gatuadress or ku:Borttag or not(ku:InkomsttagareKU68/ku:Inkomsttagare) or (string-length(ku:InkomsttagareKU68/ku:Inkomsttagare) != 12) or number(substring(ku:InkomsttagareKU68/ku:Inkomsttagare,1,4)) &lt;= 1800 or number(substring(ku:InkomsttagareKU68/ku:Inkomsttagare,7,2)) &lt;= 60 or ku:InkomsttagareKU68/ku:FriAdress">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>144#Du har angett ett s.k. samordningsnummer i fältet Person-/organisationsnummer, fält 215. Du ska då också ange Gatuadress, fält 218</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU68/ku:Gatuadress or not(ku:InkomsttagareKU68/ku:AnnatIDNr) or ku:Borttag or ku:InkomsttagareKU68/ku:Inkomsttagare or ku:InkomsttagareKU68/ku:Fodelsetid or ku:InkomsttagareKU68/ku:FriAdress"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU68/ku:Gatuadress or not(ku:InkomsttagareKU68/ku:AnnatIDNr) or ku:Borttag or ku:InkomsttagareKU68/ku:Inkomsttagare or ku:InkomsttagareKU68/ku:Fodelsetid or ku:InkomsttagareKU68/ku:FriAdress">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>152#Du har angett Annat ID-nummer, fält 224. Du ska då också ange Gatuadress, fält 218</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU68/ku:Postnummer or not(ku:InkomsttagareKU68/ku:Fodelsetid) or ku:Borttag or ku:InkomsttagareKU68/ku:FriAdress"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU68/ku:Postnummer or not(ku:InkomsttagareKU68/ku:Fodelsetid) or ku:Borttag or ku:InkomsttagareKU68/ku:FriAdress">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>060#Du har angett Födelsetid, fält 222. Du ska då också ange Postnummer, fält 219</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU68/ku:Postnummer or ku:Borttag or not(ku:InkomsttagareKU68/ku:Inkomsttagare) or (string-length(ku:InkomsttagareKU68/ku:Inkomsttagare) != 12) or number(substring(ku:InkomsttagareKU68/ku:Inkomsttagare,1,4)) &lt;= 1800 or number(substring(ku:InkomsttagareKU68/ku:Inkomsttagare,7,2)) &lt;= 60 or ku:InkomsttagareKU68/ku:FriAdress"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU68/ku:Postnummer or ku:Borttag or not(ku:InkomsttagareKU68/ku:Inkomsttagare) or (string-length(ku:InkomsttagareKU68/ku:Inkomsttagare) != 12) or number(substring(ku:InkomsttagareKU68/ku:Inkomsttagare,1,4)) &lt;= 1800 or number(substring(ku:InkomsttagareKU68/ku:Inkomsttagare,7,2)) &lt;= 60 or ku:InkomsttagareKU68/ku:FriAdress">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>145#Du har angett ett s.k. samordningsnummer i fältet Person-/organisationsnummer, fält 215. Du ska då också ange Postnummer, fält 219</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU68/ku:Postnummer or not(ku:InkomsttagareKU68/ku:AnnatIDNr) or ku:Borttag or ku:InkomsttagareKU68/ku:Inkomsttagare or ku:InkomsttagareKU68/ku:Fodelsetid or ku:InkomsttagareKU68/ku:FriAdress"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU68/ku:Postnummer or not(ku:InkomsttagareKU68/ku:AnnatIDNr) or ku:Borttag or ku:InkomsttagareKU68/ku:Inkomsttagare or ku:InkomsttagareKU68/ku:Fodelsetid or ku:InkomsttagareKU68/ku:FriAdress">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>153#Du har angett Annat ID-nummer, fält 224. Du ska då också ange Postnummer, fält 219</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU68/ku:Postort or not(ku:InkomsttagareKU68/ku:Fodelsetid) or ku:Borttag or ku:InkomsttagareKU68/ku:FriAdress"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU68/ku:Postort or not(ku:InkomsttagareKU68/ku:Fodelsetid) or ku:Borttag or ku:InkomsttagareKU68/ku:FriAdress">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>061#Du har angett Födelsetid, fält 222. Du ska då också ange Postort, fält 220</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU68/ku:Postort or ku:Borttag or not(ku:InkomsttagareKU68/ku:Inkomsttagare) or (string-length(ku:InkomsttagareKU68/ku:Inkomsttagare) != 12) or number(substring(ku:InkomsttagareKU68/ku:Inkomsttagare,1,4)) &lt;= 1800 or number(substring(ku:InkomsttagareKU68/ku:Inkomsttagare,7,2)) &lt;= 60 or ku:InkomsttagareKU68/ku:FriAdress"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU68/ku:Postort or ku:Borttag or not(ku:InkomsttagareKU68/ku:Inkomsttagare) or (string-length(ku:InkomsttagareKU68/ku:Inkomsttagare) != 12) or number(substring(ku:InkomsttagareKU68/ku:Inkomsttagare,1,4)) &lt;= 1800 or number(substring(ku:InkomsttagareKU68/ku:Inkomsttagare,7,2)) &lt;= 60 or ku:InkomsttagareKU68/ku:FriAdress">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>146#Du har angett ett s.k. samordningsnummer i fältet Person-/organisationsnummer, fält 215. Du ska då också ange Postort, fält 220</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU68/ku:Postort or not(ku:InkomsttagareKU68/ku:AnnatIDNr) or ku:Borttag or ku:InkomsttagareKU68/ku:Inkomsttagare or ku:InkomsttagareKU68/ku:Fodelsetid or ku:InkomsttagareKU68/ku:FriAdress"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU68/ku:Postort or not(ku:InkomsttagareKU68/ku:AnnatIDNr) or ku:Borttag or ku:InkomsttagareKU68/ku:Inkomsttagare or ku:InkomsttagareKU68/ku:Fodelsetid or ku:InkomsttagareKU68/ku:FriAdress">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>154#Du har angett Annat ID-nummer, fält 224. Du ska då också ange Postort, fält 220</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="not(ku:InkomsttagareKU68/ku:FriAdress) or ku:InkomsttagareKU68/ku:LandskodPostort"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(ku:InkomsttagareKU68/ku:FriAdress) or ku:InkomsttagareKU68/ku:LandskodPostort">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>166#Du har valt att ange Adress i fritt format, fält 230. Du ska då också ange i vilket land adressen finns i fält 221, Land</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="not(ku:InkomsttagareKU68/ku:Inkomsttagare) or not(ku:InkomsttagareKU68/ku:Fodelsetid)"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(ku:InkomsttagareKU68/ku:Inkomsttagare) or not(ku:InkomsttagareKU68/ku:Fodelsetid)">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>063#Födelsetid, fält 222, får inte finnas samtidigt som Inkomsttagare, fält 215</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="not(ku:InkomsttagareKU68/ku:OrgNamn) or (not(ku:InkomsttagareKU68/ku:Fodelsetid) and (not(ku:InkomsttagareKU68/ku:Inkomsttagare) or number(substring(ku:InkomsttagareKU68/ku:Inkomsttagare,1,2)) &lt;= 17) and not(ku:InkomsttagareKU68/ku:Fornamn) and not(ku:InkomsttagareKU68/ku:Efternamn))"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(ku:InkomsttagareKU68/ku:OrgNamn) or (not(ku:InkomsttagareKU68/ku:Fodelsetid) and (not(ku:InkomsttagareKU68/ku:Inkomsttagare) or number(substring(ku:InkomsttagareKU68/ku:Inkomsttagare,1,2)) &lt;= 17) and not(ku:InkomsttagareKU68/ku:Fornamn) and not(ku:InkomsttagareKU68/ku:Efternamn))">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>065#Du har angett Organisationsnamn, fält 226. Det kan inte kombineras med person- eller samordningsnummer i Person-/organisationsnummer, fält 215, och inte heller med För- och efternamn, fält 216 - 217</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU68/ku:OrgNamn or not(ku:InkomsttagareKU68/ku:AnnatIDNr) or ku:Borttag or ku:InkomsttagareKU68/ku:Inkomsttagare or ku:InkomsttagareKU68/ku:Fornamn or ku:InkomsttagareKU68/ku:Efternamn or ku:InkomsttagareKU68/ku:Fodelsetid"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU68/ku:OrgNamn or not(ku:InkomsttagareKU68/ku:AnnatIDNr) or ku:Borttag or ku:InkomsttagareKU68/ku:Inkomsttagare or ku:InkomsttagareKU68/ku:Fornamn or ku:InkomsttagareKU68/ku:Efternamn or ku:InkomsttagareKU68/ku:Fodelsetid">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>151#Du har angett Annat ID-nummer, fält 224. Du ska då också ange Organisationsnamn, fält 226, för juridisk person eller För- och efternamn, fält 216 - 217, för fysisk person</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:Borttag or ku:AvgiftArbetsloshetskassa"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:Borttag or ku:AvgiftArbetsloshetskassa">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>191#Du har inte fyllt i Avgift till arbetslöshetskassa, fält 551</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
