...
<svrl:ns-prefix-in-attribute-values uri="http://xmls.skatteverket.se/se/skatteverket/ai/gemensamt/infoForBeskattning/4.0" prefix="gm"/>
<svrl:ns-prefix-in-attribute-values uri="http://xmls.skatteverket.se/se/skatteverket/ai/komponent/infoForBeskattning/4.0" prefix="ku"/>
<svrl:ns-prefix-in-attribute-values uri="http://xmls.skatteverket.se/se/skatteverket/ai/instans/infoForBeskattning/4.0" prefix="kuin"/>
...
<svrl:text>009#Anställd t.o.m. månad, fält 009, måste vara en senare, eller samma, månad än Anställd från månad, fält 008</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>010#Kontrolluppgiften saknar såväl ersättningar som avdragen skatt. Utan dessa värden är den alltför ofullständig för att skickas in</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>015#Du har markerat något eller några av fält 041 - 047. Du ska då också fylla i ett belopp i Skattepliktiga förmåner utom bilförmån och drivmedel vid bilförmån, fält 012</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>017#Du har fyllt i underlag för skattereduktion för rut-/rotarbete, fält 021 - 022. Du ska då också fylla i ett belopp i fältet Skattepliktiga förmåner utom bilförmån och drivmedel vid bilförmån, fält 012</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>019#Du har fyllt i något eller några av fälten 014, 015 och 017. Du ska då också fylla i ett belopp i Skattepliktig bilförmån utom drivmedel, fält 013</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>030#Du har fyllt i Skattepliktig bilförmån utom drivmedel, fält 013. Du ska då också fylla i Kod för förmånsbil, fält 014</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>035#Du har fyllt i Specifikation av belopp i fält 070, fält 037. Du måste då också fylla i Vissa avdrag, fält 037</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>036#Du har fyllt i Skattepliktiga förmåner utom bilförmån och drivmedel vid bilförmån, fält 012. Du ska då också markera vad förmånen/förmånerna avser i något/några av fälten 041 - 047. Om du markerar Annan förmån, fält 047, ska du också fylla i Specifikation av annan förmån i fält 047, fält 065</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>037#Du har fyllt i Specifikation av annan förmån i fält 047, fält 065. Du ska då också markera Annan förmån, fält 047</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>038#Du har markerat Förmån har justerats, fält 048. Du ska då också fylla i ett belopp i Skattepliktig bilförmån utom drivmedel, fält 013, eller Skattepliktiga förmåner utom bilförmån och drivmedel vid bilförmån, fält 012</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>041#Du har markerat Annan förmån, fält 047. Du ska då också fylla i Specifikation av annan förmån i fält 047, fält 065</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>042#När du har angett ett belopp i Vissa avdrag, fält 037, ska du också specificera vad beloppet avser i Specifikation av belopp i fält 037, fält 070</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>011#Kontrolluppgiften saknar såväl ersättningar som avdragen skatt. Utan dessa värden är den alltför ofullständig för att skickas in</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>016#Du har markerat något eller några av fält 041 - 047. Du ska då också fylla i ett belopp i Skattepliktiga förmåner utom bilförmån och drivmedel vid bilförmån, fält 012</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:BilformanUtomDrivmedel or ku:ErsEjSocAvg or (not(ku:KodForFormansbil) and not(ku:AntalManBilforman) and not(ku:BetaltForBilforman))"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:BilformanUtomDrivmedel or ku:ErsEjSocAvg or (not(ku:KodForFormansbil) and not(ku:AntalManBilforman) and not(ku:BetaltForBilforman))">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>020#Du har fyllt i något eller några av fälten 014, 015 och 017. Du ska då också fylla i ett belopp i Skattepliktig bilförmån utom drivmedel, fält 013</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>039#Du har markerat Förmån har justerats, fält 048. Du ska då också fylla i ett belopp i Skattepliktig bilförmån utom drivmedel, fält 013, eller Skattepliktiga förmåner utom bilförmån och drivmedel vid bilförmån, fält 012</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>013#Kontrolluppgiften saknar såväl ersättningar som avdragen skatt. Utan dessa värden är den alltför ofullständig för att skickas in</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>018#Du har markerat kostförmån, fält 042. Du ska då också fylla i ett belopp i Skattepliktiga förmåner utom bilförmån och drivmedel vid bilförmån, fält 012</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>014#Kontrolluppgiften saknar såväl ersättningar som avdragen skatt. Utan dessa värden är den alltför ofullständig för att skickas in</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU66" priority="1008" mode="M5">
...
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
<xsl:template match="ku:KU67" priority="1007" mode="M5">
<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ku:KU67"/>

		<!--ASSERT -->
<xsl:choose>
<xsl:when test="not(ku:InkomsttagareKU67/ku:TIN) or ku:InkomsttagareKU67/ku:LandskodTIN"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(ku:InkomsttagareKU67/ku:TIN) or ku:InkomsttagareKU67/ku:LandskodTIN">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>045#Du har angett Utländskt skatteregistreringsnummer (TIN), fält 252. Då ska du också ange vilket land det gäller i TIN-land, fält 076</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="not(ku:UppgiftslamnareKU67/ku:UppgiftslamnarId) or not(ku:InkomsttagareKU67/ku:Inkomsttagare) or ku:UppgiftslamnareKU67/ku:UppgiftslamnarId != ku:InkomsttagareKU67/ku:Inkomsttagare"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(ku:UppgiftslamnareKU67/ku:UppgiftslamnarId) or not(ku:InkomsttagareKU67/ku:Inkomsttagare) or ku:UppgiftslamnareKU67/ku:UppgiftslamnarId != ku:InkomsttagareKU67/ku:Inkomsttagare">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>053#Du har angett samma person-/organisationsnummer för den kontrolluppgiften avser i Person-/organisationsnummer, fält 215, som du angett som uppgiftslämnare. Det kan aldrig vara samma person</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="not(ku:Borttag) or (ku:Borttag and (count(ku:Borttag) + count(ku:UppgiftslamnareKU67/ku:UppgiftslamnarId) + count(ku:Inkomstar) + count(ku:Specifikationsnummer) + count(ku:InkomsttagareKU67/ku:Inkomsttagare) + count(ku:InkomsttagareKU67/ku:Fodelsetid) + count(ku:InkomsttagareKU67/ku:AnnatIDNr) = count(*) - 2 + count(//ku:UppgiftslamnareKU67/*) + count(//ku:InkomsttagareKU67/*)))"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(ku:Borttag) or (ku:Borttag and (count(ku:Borttag) + count(ku:UppgiftslamnareKU67/ku:UppgiftslamnarId) + count(ku:Inkomstar) + count(ku:Specifikationsnummer) + count(ku:InkomsttagareKU67/ku:Inkomsttagare) + count(ku:InkomsttagareKU67/ku:Fodelsetid) + count(ku:InkomsttagareKU67/ku:AnnatIDNr) = count(*) - 2 + count(//ku:UppgiftslamnareKU67/*) + count(//ku:InkomsttagareKU67/*)))">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>055#När Borttag, fält 205, är ifyllt får inte några andra fält förutom identifikatorerna (UppgiftslamnarId, fält 201, Inkomstar, fält 203, Specifikationsnummer, fält 570, Inkomsttagare, fält 215, Fodelsetid, fält 222 och AnnatIdNr, fält 224) vara ifyllda</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU67/ku:Fodelsetid or ku:InkomsttagareKU67/ku:AnnatIDNr or ku:InkomsttagareKU67/ku:Inkomsttagare"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU67/ku:Fodelsetid or ku:InkomsttagareKU67/ku:AnnatIDNr or ku:InkomsttagareKU67/ku:Inkomsttagare">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>056#Du har inte angett Person-/organisationsnummer, fält 215, och inte heller Födelsetid, fält 222, eller Annat ID-nummer (för juridiska personer), fält 224. Någon av dessa ska anges</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU67/ku:Fornamn or not(ku:InkomsttagareKU67/ku:Fodelsetid) or ku:Borttag"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU67/ku:Fornamn or not(ku:InkomsttagareKU67/ku:Fodelsetid) or ku:Borttag">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>057#Du har angett Födelsetid, fält 222. Du ska då också ange Förnamn, fält 216</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU67/ku:Fornamn or ku:Borttag or not(ku:InkomsttagareKU67/ku:Inkomsttagare) or (string-length(ku:InkomsttagareKU67/ku:Inkomsttagare) != 12) or number(substring(ku:InkomsttagareKU67/ku:Inkomsttagare,1,4)) &lt;= 1800 or number(substring(ku:InkomsttagareKU67/ku:Inkomsttagare,7,2)) &lt;= 60"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU67/ku:Fornamn or ku:Borttag or not(ku:InkomsttagareKU67/ku:Inkomsttagare) or (string-length(ku:InkomsttagareKU67/ku:Inkomsttagare) != 12) or number(substring(ku:InkomsttagareKU67/ku:Inkomsttagare,1,4)) &lt;= 1800 or number(substring(ku:InkomsttagareKU67/ku:Inkomsttagare,7,2)) &lt;= 60">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>142#Du har angett ett s.k. samordningsnummer i fältet Person-/organisationsnummer, fält 215. Du ska då också ange Förnamn, fält 216</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU67/ku:Efternamn or not(ku:InkomsttagareKU67/ku:Fodelsetid) or ku:Borttag"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU67/ku:Efternamn or not(ku:InkomsttagareKU67/ku:Fodelsetid) or ku:Borttag">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>058#Du har angett Födelsetid, fält 222. Du ska då också ange Efternamn, fält 217</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU67/ku:Efternamn or ku:Borttag or not(ku:InkomsttagareKU67/ku:Inkomsttagare) or (string-length(ku:InkomsttagareKU67/ku:Inkomsttagare) != 12) or number(substring(ku:InkomsttagareKU67/ku:Inkomsttagare,1,4)) &lt;= 1800 or number(substring(ku:InkomsttagareKU67/ku:Inkomsttagare,7,2)) &lt;= 60"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU67/ku:Efternamn or ku:Borttag or not(ku:InkomsttagareKU67/ku:Inkomsttagare) or (string-length(ku:InkomsttagareKU67/ku:Inkomsttagare) != 12) or number(substring(ku:InkomsttagareKU67/ku:Inkomsttagare,1,4)) &lt;= 1800 or number(substring(ku:InkomsttagareKU67/ku:Inkomsttagare,7,2)) &lt;= 60">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>143#Du har angett ett s.k. samordningsnummer i fältet Person-/organisationsnummer, fält 215. Du ska då också ange Efternamn, fält 217</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU67/ku:Gatuadress or not(ku:InkomsttagareKU67/ku:Fodelsetid) or ku:Borttag or ku:InkomsttagareKU67/ku:FriAdress"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU67/ku:Gatuadress or not(ku:InkomsttagareKU67/ku:Fodelsetid) or ku:Borttag or ku:InkomsttagareKU67/ku:FriAdress">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>059#Du har angett Födelsetid, fält 222. Du ska då också ange Gatuadress, fält 218</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU67/ku:Gatuadress or ku:Borttag or not(ku:InkomsttagareKU67/ku:Inkomsttagare) or (string-length(ku:InkomsttagareKU67/ku:Inkomsttagare) != 12) or number(substring(ku:InkomsttagareKU67/ku:Inkomsttagare,1,4)) &lt;= 1800 or number(substring(ku:InkomsttagareKU67/ku:Inkomsttagare,7,2)) &lt;= 60 or ku:InkomsttagareKU67/ku:FriAdress"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU67/ku:Gatuadress or ku:Borttag or not(ku:InkomsttagareKU67/ku:Inkomsttagare) or (string-length(ku:InkomsttagareKU67/ku:Inkomsttagare) != 12) or number(substring(ku:InkomsttagareKU67/ku:Inkomsttagare,1,4)) &lt;= 1800 or number(substring(ku:InkomsttagareKU67/ku:Inkomsttagare,7,2)) &lt;= 60 or ku:InkomsttagareKU67/ku:FriAdress">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>144#Du har angett ett s.k. samordningsnummer i fältet Person-/organisationsnummer, fält 215. Du ska då också ange Gatuadress, fält 218</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU67/ku:Gatuadress or not(ku:InkomsttagareKU67/ku:AnnatIDNr) or ku:Borttag or ku:InkomsttagareKU67/ku:Inkomsttagare or ku:InkomsttagareKU67/ku:Fodelsetid or ku:InkomsttagareKU67/ku:FriAdress"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU67/ku:Gatuadress or not(ku:InkomsttagareKU67/ku:AnnatIDNr) or ku:Borttag or ku:InkomsttagareKU67/ku:Inkomsttagare or ku:InkomsttagareKU67/ku:Fodelsetid or ku:InkomsttagareKU67/ku:FriAdress">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>152#Du har angett Annat ID-nummer, fält 224. Du ska då också ange Gatuadress, fält 218</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU67/ku:Postnummer or not(ku:InkomsttagareKU67/ku:Fodelsetid) or ku:Borttag or ku:InkomsttagareKU67/ku:FriAdress"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU67/ku:Postnummer or not(ku:InkomsttagareKU67/ku:Fodelsetid) or ku:Borttag or ku:InkomsttagareKU67/ku:FriAdress">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>060#Du har angett Födelsetid, fält 222. Du ska då också ange Postnummer, fält 219</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU67/ku:Postnummer or ku:Borttag or not(ku:InkomsttagareKU67/ku:Inkomsttagare) or (string-length(ku:InkomsttagareKU67/ku:Inkomsttagare) != 12) or number(substring(ku:InkomsttagareKU67/ku:Inkomsttagare,1,4)) &lt;= 1800 or number(substring(ku:InkomsttagareKU67/ku:Inkomsttagare,7,2)) &lt;= 60 or ku:InkomsttagareKU67/ku:FriAdress"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU67/ku:Postnummer or ku:Borttag or not(ku:InkomsttagareKU67/ku:Inkomsttagare) or (string-length(ku:InkomsttagareKU67/ku:Inkomsttagare) != 12) or number(substring(ku:InkomsttagareKU67/ku:Inkomsttagare,1,4)) &lt;= 1800 or number(substring(ku:InkomsttagareKU67/ku:Inkomsttagare,7,2)) &lt;= 60 or ku:InkomsttagareKU67/ku:FriAdress">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>145#Du har angett ett s.k. samordningsnummer i fältet Person-/organisationsnummer, fält 215. Du ska då också ange Postnummer, fält 219</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU67/ku:Postnummer or not(ku:InkomsttagareKU67/ku:AnnatIDNr) or ku:Borttag or ku:InkomsttagareKU67/ku:Inkomsttagare or ku:InkomsttagareKU67/ku:Fodelsetid or ku:InkomsttagareKU67/ku:FriAdress"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU67/ku:Postnummer or not(ku:InkomsttagareKU67/ku:AnnatIDNr) or ku:Borttag or ku:InkomsttagareKU67/ku:Inkomsttagare or ku:InkomsttagareKU67/ku:Fodelsetid or ku:InkomsttagareKU67/ku:FriAdress">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>153#Du har angett Annat ID-nummer, fält 224. Du ska då också ange Postnummer, fält 219</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU67/ku:Postort or not(ku:InkomsttagareKU67/ku:Fodelsetid) or ku:Borttag or ku:InkomsttagareKU67/ku:FriAdress"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU67/ku:Postort or not(ku:InkomsttagareKU67/ku:Fodelsetid) or ku:Borttag or ku:InkomsttagareKU67/ku:FriAdress">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>061#Du har angett Födelsetid, fält 222. Du ska då också ange Postort, fält 220</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU67/ku:Postort or ku:Borttag or not(ku:InkomsttagareKU67/ku:Inkomsttagare) or (string-length(ku:InkomsttagareKU67/ku:Inkomsttagare) != 12) or number(substring(ku:InkomsttagareKU67/ku:Inkomsttagare,1,4)) &lt;= 1800 or number(substring(ku:InkomsttagareKU67/ku:Inkomsttagare,7,2)) &lt;= 60 or ku:InkomsttagareKU67/ku:FriAdress"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU67/ku:Postort or ku:Borttag or not(ku:InkomsttagareKU67/ku:Inkomsttagare) or (string-length(ku:InkomsttagareKU67/ku:Inkomsttagare) != 12) or number(substring(ku:InkomsttagareKU67/ku:Inkomsttagare,1,4)) &lt;= 1800 or number(substring(ku:InkomsttagareKU67/ku:Inkomsttagare,7,2)) &lt;= 60 or ku:InkomsttagareKU67/ku:FriAdress">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>146#Du har angett ett s.k. samordningsnummer i fältet Person-/organisationsnummer, fält 215. Du ska då också ange Postort, fält 220</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU67/ku:Postort or not(ku:InkomsttagareKU67/ku:AnnatIDNr) or ku:Borttag or ku:InkomsttagareKU67/ku:Inkomsttagare or ku:InkomsttagareKU67/ku:Fodelsetid or ku:InkomsttagareKU67/ku:FriAdress"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU67/ku:Postort or not(ku:InkomsttagareKU67/ku:AnnatIDNr) or ku:Borttag or ku:InkomsttagareKU67/ku:Inkomsttagare or ku:InkomsttagareKU67/ku:Fodelsetid or ku:InkomsttagareKU67/ku:FriAdress">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>154#Du har angett Annat ID-nummer, fält 224. Du ska då också ange Postort, fält 220</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="not(ku:InkomsttagareKU67/ku:FriAdress) or ku:InkomsttagareKU67/ku:LandskodPostort"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(ku:InkomsttagareKU67/ku:FriAdress) or ku:InkomsttagareKU67/ku:LandskodPostort">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>166#Du har valt att ange Adress i fritt format, fält 230. Du ska då också ange i vilket land adressen finns i fält 221, Land. </svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="not(ku:InkomsttagareKU67/ku:Inkomsttagare) or not(ku:InkomsttagareKU67/ku:Fodelsetid)"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(ku:InkomsttagareKU67/ku:Inkomsttagare) or not(ku:InkomsttagareKU67/ku:Fodelsetid)">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>063#Födelsetid, fält 222, får inte finnas samtidigt som Inkomsttagare, fält 215</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="not(ku:InkomsttagareKU67/ku:OrgNamn) or (not(ku:InkomsttagareKU67/ku:Fodelsetid) and (not(ku:InkomsttagareKU67/ku:Inkomsttagare) or number(substring(ku:InkomsttagareKU67/ku:Inkomsttagare,1,2)) &lt;= 17) and not(ku:InkomsttagareKU67/ku:Fornamn) and not(ku:InkomsttagareKU67/ku:Efternamn))"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(ku:InkomsttagareKU67/ku:OrgNamn) or (not(ku:InkomsttagareKU67/ku:Fodelsetid) and (not(ku:InkomsttagareKU67/ku:Inkomsttagare) or number(substring(ku:InkomsttagareKU67/ku:Inkomsttagare,1,2)) &lt;= 17) and not(ku:InkomsttagareKU67/ku:Fornamn) and not(ku:InkomsttagareKU67/ku:Efternamn))">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>065#Du har angett Organisationsnamn, fält 226. Det kan inte kombineras med person- eller samordningsnummer i Person-/organisationsnummer, fält 215, och inte heller med För- och efternamn, fält 216 - 217</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:InkomsttagareKU67/ku:OrgNamn or not(ku:InkomsttagareKU67/ku:AnnatIDNr) or ku:Borttag or ku:InkomsttagareKU67/ku:Inkomsttagare or ku:InkomsttagareKU67/ku:Fornamn or ku:InkomsttagareKU67/ku:Efternamn or ku:InkomsttagareKU67/ku:Fodelsetid"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:InkomsttagareKU67/ku:OrgNamn or not(ku:InkomsttagareKU67/ku:AnnatIDNr) or ku:Borttag or ku:InkomsttagareKU67/ku:Inkomsttagare or ku:InkomsttagareKU67/ku:Fornamn or ku:InkomsttagareKU67/ku:Efternamn or ku:InkomsttagareKU67/ku:Fodelsetid">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>151#Du har angett Annat ID-nummer, fält 224. Du ska då också ange Organisationsnamn, fält 226, för juridisk person eller För- och efternamn, fält 216 - 217, för fysisk person</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="not(ku:InkomsttagareKU67/ku:LandskodTIN) or ku:InkomsttagareKU67/ku:TIN"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(ku:InkomsttagareKU67/ku:LandskodTIN) or ku:InkomsttagareKU67/ku:TIN">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>066#Du har angett TIN-land, fält 076, dvs ett land för vilket ett utländskt skatteregistreringsnummer ska gälla. Du behöver också ange Utländskt skatteregistreringsnummer (TIN), fält 252</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:Borttag or ku:MedlemsavgArbetstagarorg"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:Borttag or ku:MedlemsavgArbetstagarorg">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>182#Medlemsavgifter till arbetstagarorganisation, fält 550, ska alltid fyllas i.</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
