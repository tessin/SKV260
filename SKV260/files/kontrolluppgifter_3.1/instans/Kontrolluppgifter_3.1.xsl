...
<svrl:ns-prefix-in-attribute-values uri="http://xmls.skatteverket.se/se/skatteverket/ai/gemensamt/infoForBeskattning/3.1" prefix="gm"/>
<svrl:ns-prefix-in-attribute-values uri="http://xmls.skatteverket.se/se/skatteverket/ai/komponent/infoForBeskattning/3.1" prefix="ku"/>
<svrl:ns-prefix-in-attribute-values uri="http://xmls.skatteverket.se/se/skatteverket/ai/instans/infoForBeskattning/3.1" prefix="kuin"/>
...
<svrl:text>Du har inte angett Person-/organisationsnummer, fält 215, och inte heller Födelsetid, fält 222, eller Annat ID-nummer (för juridiska personer), fält 224. Någon av dessa ska anges</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="not(ku:InkomsttagareKU10/ku:Inkomsttagare) or number(substring(ku:InkomsttagareKU10/ku:Inkomsttagare,1,2)) &gt;= 17 or ((not(ku:KontantBruttolonMm) or number(ku:KontantBruttolonMm) = 0) and (not(ku:FormanUtomBilDrivmedel) or number(ku:FormanUtomBilDrivmedel) = 0) and (not(ku:BilformanUtomDrivmedel) or number(ku:BilformanUtomDrivmedel) = 0) and (not(ku:ErsMEgenavgifter) or number(ku:ErsMEgenavgifter) = 0))"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="not(ku:InkomsttagareKU10/ku:Inkomsttagare) or number(substring(ku:InkomsttagareKU10/ku:Inkomsttagare,1,2)) &gt;= 17 or ((not(ku:KontantBruttolonMm) or number(ku:KontantBruttolonMm) = 0) and (not(ku:FormanUtomBilDrivmedel) or number(ku:FormanUtomBilDrivmedel) = 0) and (not(ku:BilformanUtomDrivmedel) or number(ku:BilformanUtomDrivmedel) = 0) and (not(ku:ErsMEgenavgifter) or number(ku:ErsMEgenavgifter) = 0))">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>Du har fyllt i ersättning i form av lön m.m., fält 011 eller fält 025, eller förmån, fält 012 eller 013, när kontrolluppgiften avser en juridisk person. Ersättning till en juridisk person ska redovisas i fältet Ersättningar som inte är underlag för socialavgifter, fält 031.</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>Du har valt att ange Adress i fritt format, fält 230. Du ska då också ange i vilket land adressen finns i fält 221, Land. </svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>Du har markerat något eller några av fält 041 - 047. Du ska då också fylla i ett belopp i Skattepliktiga förmåner utom bilförmån och drivmedel vid bilförmån, fält 012</svrl:text>
		...
		<!--ASSERT -->
<xsl:choose>
<xsl:when test="ku:BilformanUtomDrivmedel or (not(ku:KodForFormansbil) and not(ku:AntalManBilforman) and not(ku:BetaltForBilforman))"/>
<xsl:otherwise>
<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="ku:BilformanUtomDrivmedel or (not(ku:KodForFormansbil) and not(ku:AntalManBilforman) and not(ku:BetaltForBilforman))">
<xsl:attribute name="location">
<xsl:apply-templates select="." mode="schematron-select-full-path"/>
</xsl:attribute>
<svrl:text>Du har fyllt i något eller några av fälten 014, 015 och 017. Du ska då också fylla i ett belopp i Skattepliktig bilförmån utom drivmedel, fält 013</svrl:text>
...
<svrl:text>Du har fyllt i Underlag för investeraravdrag, fält 528. Du ska då också fylla i Totalt underlag för investeraravdrag, fält 529.</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>När du markerat Återföring på grund av avyttring, fält 531, kan du inte fylla i Totalt underlag för investeraravdrag, fält 529 på samma kontrolluppgift</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>Du har varken angett Utdelning, fält 574, Avdragen skatt, fält 001, Annan inkomst, fält 504, Annan kupongskattepliktig ersättning, fält 581 eller Okänt värde, fält 599. Kontrolluppgiften är därför alltför ofullständig för att skickas in</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>När man markerat Optionen förfallen, fält 813, kan man inte markera Avyttrad till investeringssparkonto, fält 573</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>Du har varken fyllt i Erhållen ersättning, fält 810, Optionen förfallen, fält 813 eller Okänt värde, fält 599. Kontrolluppgiften är därför alltför ofullständig för att skickas in</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>Du har angett att Överlåtelsen har skett genom arv, gåva, bodelning eller liknande, fält 633, och Tilläggsköpeskilling, fält 639. När man redovisar tilläggsköpeskilling kan man inte samtidigt ange att överlåtelsen skett genom gåva m.m.</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>Du har inte angett varken Överlåtelsepris, fält 634, att Överlåtelsen har skett genom arv, gåva, bodelning eller liknande, fält 633, eller Tilläggsköpeskilling, fält 639</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>Du har fyllt i ett högre belopp i Del av utdelningen som kommer från intäkt av skogsbruk, fält 731, än i Tillgodoräknad utdelning, fält 730. Del av utdelningen som kommer från intäkt av skogsbruk, fält 731, måste, om det fylls i, alltid vara ett lägre belopp</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
...
<svrl:text>Du har fyllt i både Tillgodoräknad utdelning, fält 730, och Delägarens skattepliktiga andel i samfällighetens inkomster som är avkastning på kapital, fält 732. Båda kan inte vara ifyllda på samma kontrolluppgift</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
<xsl:apply-templates select="*|comment()|processing-instruction()" mode="M5"/>
...
<svrl:text>Du har inte angett Person-/organisationsnummer, fält 215, och inte heller Födelsetid, fält 222. Någon av dessa ska anges.</svrl:text>
</svrl:failed-assert>
</xsl:otherwise>
</xsl:choose>
